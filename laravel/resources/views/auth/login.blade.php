                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="{{ route('client.category') }}"> shop category</a>
                        ...
                        <div class="hearer_icon d-flex">
                            ...
                            <div style="margin-right: 8px"><a href="{{ route('auth.getLogin')}}"><i class="fas fa-user"></i></a></div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            @endif
                            <form class="row contact_form" action="{{ route('auth.postLogin') }}" method="POST">
                                @csrf
